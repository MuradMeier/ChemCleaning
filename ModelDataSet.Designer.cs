...
namespace ChimChi {
    ...
    public partial class ModelDataSet : global::System.Data.DataSet {
        ...
        public partial class LoginDataTable : global::System.Data.TypedTableBase<LoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LoginRow AddLoginRow(string Username, string Password, string Role, string RealName) {
        ...
        public partial class LoginRow : global::System.Data.DataRow {
            ...
            public string RealName {
                get {
                    return ((string)(this[this.tableLogin.RealNameColumn]));
                }
                set {
                    this[this.tableLogin.RealNameColumn] = value;
                }
            }
        }
...
namespace ChimChi.ModelDataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Login] WHERE (([Username] = @Original_Username) AND ([Password" +
                "] = @Original_Password) AND ([Role] = @Original_Role) AND ([RealName] = @Origina" +
                "l_RealName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Login] ([Username], [Password], [Role], [RealName]) VALUES (@U" +
                "sername, @Password, @Role, @RealName);\r\nSELECT Username, Password, Role, RealNam" +
                "e FROM Login WHERE (Username = @Username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Login] SET [Username] = @Username, [Password] = @Password, [Role] = @Role, [RealName] = @RealName WHERE (([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Role] = @Original_Role) AND ([RealName] = @Original_RealName));
SELECT Username, Password, Role, RealName FROM Login WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ChimChi.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Role, RealName FROM dbo.Login";
        ...
        public virtual int Fill(ModelDataSet.LoginDataTable dataTable) {
        ...
        public virtual ModelDataSet.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ModelDataSet.LoginDataTable dataTable = new ModelDataSet.LoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ModelDataSet.LoginDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Username, string Original_Password, string Original_Role, string Original_RealName) {
        ...
        public virtual int Insert(string Username, string Password, string Role, string RealName) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Role, string RealName, string Original_Username, string Original_Password, string Original_Role, string Original_RealName) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
            ...
            if ((Original_RealName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_RealName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Role, string RealName, string Original_Username, string Original_Password, string Original_Role, string Original_RealName) {
            return this.Update(Original_Username, Password, Role, RealName, Original_Username, Original_Password, Original_Role, Original_RealName);
        }
    }
